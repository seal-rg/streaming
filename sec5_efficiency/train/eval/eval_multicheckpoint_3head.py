...
class MultiHeadMedusaInference:
    ...
    def generate_all_heads(
        ...
        setattr(self.model, "system_message", system_text or "You are a helpful assistant.")
        out = self._gen_fn(
...
def main():
    ap = argparse.ArgumentParser(
        description="Evaluate multiple checkpoints on multiple heads/tasks with task-specific metrics."
    )
